  ...
  return (
    <nav className={`container ${sticky ? 'dark-nav' : ''}`}>
      ...
      <ul className={mobileMenu ? '' : 'hide-mobile-menu'}>
        ...
        <li><Link to='programs' smooth={true} offset={-260} duration={500}>Programação</Link></li>
        <li><Link to='about' smooth={true} offset={-150} duration={500}>Sobre Nós</Link></li>
        <li><Link to='campus' smooth={true} offset={-260} duration={500}>Campus</Link></li>
        <li><Link to='testimonials' smooth={true} offset={-260} duration={500}>Certificados</Link></li>
